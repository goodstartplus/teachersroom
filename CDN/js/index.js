...
function websdkready() {
  ...
  // if (!china) ZoomMtg.setZoomJSLib('https://source.zoom.us/2.15.2/lib', '/av'); // CDN version default
  // else ZoomMtg.setZoomJSLib('https://jssdk.zoomus.cn/2.15.2/lib', '/av'); // china cdn option
